        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-6 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <a
                href="/services"
                className="bg-[#b8985a] hover:bg-[#9c8544]  py-3 px-6 rounded-md font-medium text-center transition-colors border border-[#b8985a]"
              >
                Explore Our Services
              </a>
              <a
                href="/contactUs"
                className="bg-transparent hover:bg-[#302c20] text-black hover:text-[#fff]  border border-1-[#b8985a] py-3 px-6 rounded-md font-medium text-center transition-colors"
              >
                Contact Us
              </a>
            </div>
