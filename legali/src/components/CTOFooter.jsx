    ...
    <section className="w-full bg-[#ffffff]">
      ...
      <div className="py-12 px-4 bg-[#ffffff]">
        <div className="container mx-auto text-center max-w-4xl">
          <h2 className="text-3xl md:text-4xl font-bold text-[#010101] mb-6">
            One-Stop Solution for All Your Document Processing Needs in the UAE
          </h2>
          <Link
            to="/contactUs"
            className="inline-block bg-[#b8985a] hover:bg-[#9c8544] text-[#010101] py-3 px-8 rounded-md font-medium transition-colors"
          >
      ...
      <div className="w-full">
        <div className="grid md:grid-cols-2">
          ...
          <div className="bg-[#ffffff] text-[#b8985a] p-8 md:p-12 flex flex-col justify-center border-t-2 md:border-t-0 border-[#b8985a]">
            ...
            <div className="mt-8">
              <Link
                to="/contactUs"
                className="inline-flex items-center bg-transparent bg-gradient-to-r from-[#b8985a] to-[#9c8544] hover:from-[#9c8544] hover:to-[#8B7500] text-[#010101] px-6 py-3 rounded-md font-medium transition-colors border border-[#b8985a]"
              >
                Get Started
